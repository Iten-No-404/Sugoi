...
{  
     ...
     txtFile.open("GET", "http://localhost:5500/Sugoi-Web/src/main/webapp/Interface/Suggestions.txt", true);
...
if(SpeechRecognition) {
  ...
  recognition.continuous = true;
   //recognition.lang = "ar-EG"; //If we want an Arabic recognition instead.//Very Inaccurate though
