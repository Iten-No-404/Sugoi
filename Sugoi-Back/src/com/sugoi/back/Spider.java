        ...
        synchronized (mClient) {
            {
                if (!Definitions.USE_MONGO) {
                    ...
                    if (toVisitCount > 0) {
                        ...
                        //cVisited.countDocuments(new org.bson.Document(com.sugoi.back.Definitions.kURL, URL + '/')) > 0 ||
                        // cVisited.countDocuments(new org.bson.Document(com.sugoi.back.Definitions.kURL, URL.substring(0,URL.length() - 2))) > 0 ||
